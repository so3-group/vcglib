...
typename T::VertexType::CoordType &Edge(const int ) { vcg_assert(0);  static typename T::VertexType::CoordType dum; return dum;}
typename T::VertexType::CoordType &cEdge(const int ) const { vcg_assert(0);  static typename T::VertexType::CoordType dum; return dum;}

typename vcg::Plane3<typename T::VertexType::CoordType::ScalarType> &Plane() {vcg_assert(0);  static typename vcg::Plane3<typename T::VertexType::CoordType::ScalarType> dum; return dum;}
typename vcg::Plane3<typename T::VertexType::CoordType::ScalarType> &cPlane() const {vcg_assert(0);  static typename vcg::Plane3<typename T::VertexType::CoordType::ScalarType> dum; return dum;}
