...
VectorwiseOp<ExpressionType,Direction>::cross(const MatrixBase<OtherDerived>& other) const
{
  ...
  {
    eigen_vcg_assert(CrossReturnType::RowsAtCompileTime==3 && "the matrix must have exactly 3 rows");
  ...
  {
    eigen_vcg_assert(CrossReturnType::ColsAtCompileTime==3 && "the matrix must have exactly 3 columns");
