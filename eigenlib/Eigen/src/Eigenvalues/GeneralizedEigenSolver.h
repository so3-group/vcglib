...
//    EigenvectorsType eigenvectors() const;
    ...
    {
      eigen_vcg_assert(m_isInitialized && "GeneralizedEigenSolver is not initialized.");
    ...
    {
      eigen_vcg_assert(m_isInitialized && "EigenSolver is not initialized.");
...
GeneralizedEigenSolver<MatrixType>::compute(const MatrixType& A, const MatrixType& B, bool computeEigenvectors)
{
  ...
  using std::sqrt;
  using std::abs;
  eigen_vcg_assert(A.cols() == A.rows() && B.cols() == A.rows() && B.cols() == B.rows());
