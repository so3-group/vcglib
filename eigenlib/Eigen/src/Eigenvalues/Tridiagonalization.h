...
template<typename _MatrixType> class Tridiagonalization
{
  public:
    ...
    {
      eigen_vcg_assert(m_isInitialized && "Tridiagonalization is not initialized.");
      return m_hCoeffs;
    }
...
void tridiagonalization_inplace(MatrixType& matA, CoeffVectorType& hCoeffs)
{
  ...
  Index n = matA.rows();
  eigen_vcg_assert(n==matA.cols());
  eigen_vcg_assert(n==hCoeffs.size()+1 || n==1);
...
{
  eigen_vcg_assert(mat.cols()==mat.rows() && diag.size()==mat.rows() && subdiag.size()==mat.rows()-1);
