  ...
  template<typename _MatrixType> class RealQZ
  {
    public:
      ...
      const MatrixType& matrixQ() const {
        eigen_vcg_assert(m_isInitialized && "RealQZ is not initialized.");
        eigen_vcg_assert(m_computeQZ && "The matrices Q and Z have not been computed during the QZ decomposition.");
        return m_Q;
      }
