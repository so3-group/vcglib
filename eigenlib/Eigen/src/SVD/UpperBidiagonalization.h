...
template<typename _MatrixType> class UpperBidiagonalization
{
  public:
    ...
    */
    ...
    {
      eigen_vcg_assert(m_isInitialized && "UpperBidiagonalization is not initialized.");
...
UpperBidiagonalization<_MatrixType>& UpperBidiagonalization<_MatrixType>::compute(const _MatrixType& matrix)
{
  ...
  eigen_vcg_assert(rows >= cols && "UpperBidiagonalization is only for matrices satisfying rows>=cols.");
