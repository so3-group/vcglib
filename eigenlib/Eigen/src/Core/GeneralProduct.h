...
//         YOU_MIXED_DIFFERENT_NUMERIC_TYPES__YOU_NEED_TO_USE_THE_CAST_METHOD_OF_MATRIXBASE_TO_CAST_NUMERIC_TYPES_EXPLICITLY)
    ...
    {
      eigen_vcg_assert(m_lhs.rows() == dst.rows() && m_rhs.cols() == dst.cols());
...
{
  EIGEN_STRONG_INLINE  Scalar* data() { eigen_internal_vcg_assert(false && "should never be called"); return 0; }
};
