...
class DenseCoeffsBase<Derived,ReadOnlyAccessors> : public EigenBase<Derived>
{
  public:
    ...
    {
      eigen_internal_vcg_assert(row >= 0 && row < rows()
                        && col >= 0 && col < cols());
    ...
    {
      eigen_vcg_assert(row >= 0 && row < rows()
          && col >= 0 && col < cols());
      return derived().coeff(row, col);
    }
    ...
    {
      eigen_internal_vcg_assert(index >= 0 && index < size());
    ...
    operator[](Index index) const
    {
      ...
      #endif
      eigen_vcg_assert(index >= 0 && index < size());
      return derived().coeff(index);
    }
