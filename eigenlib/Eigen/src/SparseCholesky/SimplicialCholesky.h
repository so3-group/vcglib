...
class SimplicialCholeskyBase : internal::noncopyable
{
  ...
  public:
    ...
    {
      eigen_vcg_assert(m_isInitialized && "Simplicial LLT or LDLT is not initialized.");
    ...
    {
      eigen_vcg_assert(m_factorizationIsOk && "The decomposition is not in a valid state for solving, you must first call either compute() or symbolic()/numeric()");
  ...
  protected:
    ...
    {
      eigen_vcg_assert(matrix.rows()==matrix.cols());
...
public:
    ...
    inline const MatrixL matrixL() const {
        eigen_vcg_assert(Base::m_factorizationIsOk && "Simplicial LLT not factorized");
...
public:
    ...
    inline const VectorType vectorD() const {
        eigen_vcg_assert(Base::m_factorizationIsOk && "Simplicial LDLT not factorized");
        return Base::m_diag;
    }
    /** \returns an expression of the factor L */
    inline const MatrixL matrixL() const {
...
public:
  ...
  public:
    ...
    inline const VectorType vectorD() const {
        eigen_vcg_assert(Base::m_factorizationIsOk && "Simplicial Cholesky not factorized");
        return Base::m_diag;
    }
    ...
    void _solve(const MatrixBase<Rhs> &b, MatrixBase<Dest> &dest) const
    {
      eigen_vcg_assert(Base::m_factorizationIsOk && "The decomposition is not in a valid state for solving, you must first call either compute() or symbolic()/numeric()");
      eigen_vcg_assert(Base::m_matrix.rows()==b.rows());
