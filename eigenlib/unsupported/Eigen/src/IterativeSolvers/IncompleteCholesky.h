...
class IncompleteCholesky : internal::noncopyable
{
  ...
  public:
    ...
    {
      eigen_vcg_assert(m_isInitialized && "IncompleteLLT is not initialized.");
      return m_info;
    }
    ...
    */
    ...
    {
      eigen_vcg_assert(m_factorizationIsOk && "factorize() should be called first");
    ...
    {
      eigen_vcg_assert(m_factorizationIsOk && "IncompleteLLT did not succeed");
      eigen_vcg_assert(m_isInitialized && "IncompleteLLT is not initialized.");
...
void IncompleteCholesky<Scalar,_UpLo, OrderingType>::factorize(const _MatrixType& mat)
{
  using std::sqrt;
  using std::min;
  eigen_vcg_assert(m_analysisIsOk && "analyzePattern() should be called first"); 
